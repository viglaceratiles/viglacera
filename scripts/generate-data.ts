...
async function generate() {
  ...
  const images = await Promise.all(imageFiles.map(async file => {
    ...
    // Find metadata case-insensitively to handle git case-insensitivity issues on Windows
    ...
    return {
      ...
      size: stats.size,
      mtime: stats.mtime,
      sizeTags: fileMeta.sizeTags || [],
      surfaceTags: fileMeta.surfaceTags || [],
      materialTags: fileMeta.materialTags || [],
      otherTags: fileMeta.otherTags || fileMeta.tags || [],
